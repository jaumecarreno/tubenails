...
const EN_TRANSLATIONS: TranslationMap = {
    ...
    'results.rotationDiagnostics': 'Rotation diagnostics',
    'results.currentExpectedState': 'Current expected state',
    'results.currentVariant': 'Current variant',
    'results.lastChange': 'Last change',
    'results.stateSource': 'Source',
    'results.stateSource.exact': 'Exact',
    'results.stateSource.inferred': 'Inferred',
    'results.youtubeLiveState': 'Live YouTube state',
    'results.checkLiveState': 'Check live state',
    'results.checkingLiveState': 'Checking...',
    'results.liveStateUnavailable': 'Live YouTube state is unavailable right now.',
    'results.liveTitle': 'Live title',
    'results.liveThumbnail': 'Live thumbnail',
    'results.liveComparison': 'Comparison',
    'results.liveComparison.match': 'Aligned with expected state',
    'results.liveComparison.mismatch': 'Potential mismatch with expected state',
    'results.variantHistory': 'Variant history',
    'results.history.none': 'No exact events recorded yet.',
    'results.history.source.test_created': 'Test created',
    'results.history.source.daily_rotation': 'Daily rotation',
    'results.history.source.auto_winner': 'Auto winner applied',
    'results.history.source.manual_winner': 'Manual winner applied',
    'results.history.source.inconclusive_revert': 'Inconclusive revert to control',
    'results.dailyResultsTimeline': 'Daily results timeline',
    'results.table.date': 'Date',
    'results.table.variant': 'Variant',
    'results.table.source': 'Source',
    'results.table.title': 'Title',
    'results.table.thumbnail': 'Thumbnail',
    'results.table.impressions': 'Impressions',
    'results.table.ctr': 'CTR',
    'results.table.estimatedClicks': 'Estimated clicks',
    'results.table.views': 'Views',
    'results.table.watchMinutes': 'Watch minutes',
    'results.table.noRows': 'No daily rows yet.'
};
